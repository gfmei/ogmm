...
def mnet():
    ...
    parser.add_argument('--n_clusters', type=int, default=4, metavar='N', help='Number of clusters')
    ...
    # training set
    parser.add_argument('--exp_name', type=str, default='GMMReg4', metavar='N', help='Name of the experiment')
